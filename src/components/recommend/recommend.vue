    ...
    <scroll ref="scroll" class="recommend-content" :data="discList">
      <div>
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide" v-for="item in recommends">
                <a :href="item.linkUrl">
                  <img class="needsclick" @load="loadImage" :src="item.picUrl" width="100%" height="100%">
                </a>
              </div>
            </div>
            <!-- 如果需要分页器 -->
        ...
        <div class="recommend-list">
          ...
          <ul>
            <li @click="selectItem(item)" v-for="item in discList" class="item" v-if="discList.length>0">
              <div class="icon">
